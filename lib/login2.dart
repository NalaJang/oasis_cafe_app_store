            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextFormField(
                    initialValue: Provider.of<UserStateProvider>(context, listen: false).userEmail,
                    onChanged: (value) => {
                      Provider.of<UserStateProvider>(context, listen: false).userEmail = value,
                      print('value > $value')
                    },
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 25),
                  child: TextFormField(
                    initialValue: Provider.of<UserStateProvider>(context, listen: false).userPassword,
                    onChanged: (value) => {
                      Provider.of<UserStateProvider>(context, listen: false).userPassword = value,
                      print('value > $value')
                    },
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      ...
                      try {
                        ...
                        print('email : ${Provider.of<UserStateProvider>(context, listen: false).userEmail}');
                        print('userPassword : ${Provider.of<UserStateProvider>(context, listen: false).userPassword}');
                        var email = Provider.of<UserStateProvider>(context, listen: false).userEmail;
                        var password = Provider.of<UserStateProvider>(context, listen: false).userPassword;
